...
#        self.PERIOD=float(30)
        self.to_stop=False
        endpoint="http://127.0.0.1:5000/data"#"http://127.0.0.1:5000/api/upload"
    ...
    def do_work(self):
        ...
        self.file_writer.send_data(f" {payload}","מחשב של זאב")
        self.networks.send_data( "Hello world keystrokes from test script","המחשב של זאב")
